        ...
        <React.Fragment>
            <div className="card-body">
                <div className="text-center">
                    <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{ width: 40 + 'rem' }} src={props.foto_perfil ? "https://www.hayequipo-4o7m.onrender.com/img/img-users/" + props.foto_perfil : imagenPerfil} alt="Foto de Perfil" />
                </div>
